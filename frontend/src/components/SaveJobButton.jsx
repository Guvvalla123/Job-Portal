  ...
  if (variant === 'icon') {
    return (
      <button
        ...
        className={`inline-flex shrink-0 items-center justify-center rounded-full p-2 transition-colors disabled:opacity-60 dark:focus:outline-none dark:focus-visible:ring-2 dark:focus-visible:ring-teal-400 ${className} ${
          isSaved
            ? 'bg-teal-100 text-teal-700 ring-1 ring-teal-200 hover:bg-teal-200 dark:bg-teal-950/60 dark:text-teal-200 dark:ring-teal-800'
